...
void main() {
  ...
  group('deve ser possivel colocar bandeira em uma posição coberta', () {
    ...
    parameterizedTest(
      "testa se não é possivel colocar bandeira em posição invalida na dificuldade fácil",
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
    ...
    parameterizedTest(
      "testa se não é possivel colocar bandeira em posição invalida na dificuldade intermediário",
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
    ...
    parameterizedTest(
      "testa se não é possivel colocar bandeira em posição invalida na dificuldade difícil",
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
  ...
  group('deve ser possível remover bandeira se houver', () {
    ...
    test(
      'testa se não é possivel remover bandeira de zona quando não houver na dificuldade fácil',
      () {
        int dificuldade = 1;
        CampoMinado campoMinado = CampoMinado(dificuldade);
        for (int i = 0; i < campoMinado.tabuleiro.length; i++) {
    ...
    test(
      'testa se não é possivel remover bandeira de zona quando não houver na dificuldade intermediário',
      () {
        int dificuldade = 2;
        CampoMinado campoMinado = CampoMinado(dificuldade);
        for (int i = 0; i < campoMinado.tabuleiro.length; i++) {
    ...
    test(
      'testa se não é possivel remover bandeira de zona quando não houver na dificuldade difícil',
      () {
        int dificuldade = 3;
        CampoMinado campoMinado = CampoMinado(dificuldade);
        for (int i = 0; i < campoMinado.tabuleiro.length; i++) {
  ...
  group('deve ser possivel descobrir uma zona sem bandeira', () {
    ...
    parameterizedTest(
      'testa se não é possivel descobrir zona de posição invalida na dificuldade fácil',
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
    ...
    parameterizedTest(
      'testa se não é possivel descobrir zona de posição invalida na dificuldade intermediário',
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
    ...
    parameterizedTest(
      'testa se não é possivel descobrir zona de posição invalida na dificuldade difícil',
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
  ...
  group("não deve ser possível colocar bandeira em zona descoberta", () {
    test(
        "testa se não é possível colocar bandeira em zona descoberta na dificuldade fácil",
        () {
      int dificuldade = 1;
      CampoMinado campoMinado = CampoMinado(dificuldade);
    ...
    test(
        "testa se não é possível colocar bandeira em zona descoberta na dificuldade intermediário",
        () {
      int dificuldade = 2;
      CampoMinado campoMinado = CampoMinado(dificuldade);
    ...
    test(
        "testa se não é possível colocar bandeira em zona descoberta na dificuldade difícil",
        () {
      int dificuldade = 3;
      CampoMinado campoMinado = CampoMinado(dificuldade);
    ...
    parameterizedTest(
      'testa se não é possivel colocar bandeira em zona invalida na dificuldade fácil',
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
    ...
    parameterizedTest(
      'testa se não é possivel colocar bandeira em zona invalida na dificuldade intermediário',
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
    ...
    parameterizedTest(
      'testa se não é possivel colocar bandeira em zona invalida na dificuldade difícil',
      [
        [-1, 0],
        [0, -1],
        [-1, -1],
  ...
  group('ao haver uma vitória, todas as zonas com bombas devem ser descobertas',
      () {
    test(
  ...
  group(
    ...
    test(
      ...
      if (targetRow > 0) {
        expect(
            campoMinado.tabuleiro[targetRow - 1][targetCol].status, equals(0));
      }
      ...
      if (targetCol > 0) {
        expect(
            campoMinado.tabuleiro[targetRow][targetCol - 1].status, equals(0));
      }
